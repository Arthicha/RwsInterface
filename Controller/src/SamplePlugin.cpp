...
SamplePlugin::SamplePlugin():
    RobWorkStudioPlugin("SamplePluginUI", QIcon("/home/Projects/sdu_courses/rovis/project/workspace/RoviSamplePlugin/src/pa_icon.png"))
{
	setupUi(this);
...
{
    log().info() << "OPENxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" << "\n";
    cout << "OPEN" << endl;
    _wc = workcell;
